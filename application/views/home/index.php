	...
	<div class="card-body card-padding">
		<div class="jumbotron" style="text-align: center;">
			...
			<?php if (isset($current_user->email)) : ?>
				<a href="<?php echo site_url(SITE_AREA) ?>" class="btn btn-lg btn-success waves-effect">Go to the Admin area</a>
			<?php else :?>
				<a href="<?php echo site_url(LOGIN_URL); ?>" class="btn btn-lg btn-primary waves-effect"><?php echo lang('bf_action_login'); ?></a>
			<?php endif;?>

			<br/><br/><a href="<?php echo site_url('/docs') ?>" class="btn btn-lg btn-info waves-effect">Browse the Docs</a>
		</div>
	</div>
</div>

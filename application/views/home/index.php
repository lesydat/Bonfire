<div class="jumbotron">
	<h1 class="display-4">Welcome to Bonfire</h1>
	...
	<?php if (isset($current_user->email)) : ?>
		<a href="<?php echo site_url(SITE_AREA) ?>" class="btn btn-lg btn-outline-success">Go to the Admin area</a>
<?php else :?>
		<a href="<?php echo site_url(LOGIN_URL); ?>" class="btn btn-lg btn-outline-primary"><?php echo lang('bf_action_login'); ?></a>
<?php endif;?>

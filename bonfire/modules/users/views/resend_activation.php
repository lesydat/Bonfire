	...
	<div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
		...
		<div class="card">
			<div class="card-body p-4 p-sm-5">
				...
				<h5 class="mb-0"><?php echo lang('us_activate_resend'); ?></h5>
				...
				<?php echo form_open($this->uri->uri_string(), array('class' => "mt-4", 'autocomplete' => 'off')); ?>
					...
					<div class="form-group">
						<button class="btn btn-primary btn-block mt-3" type="submit" name="send"><?php echo lang('us_activate_code_send') ?></button>
					</div>
				<?php echo form_close(); ?>
